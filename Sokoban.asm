...
currentPrintingColor: var#1 ; 0 is the vale for white, USE 1 FOR NO COLOR
...
InputHandler:
	...
	; if esc
		...
		loadn r0, #ConfirmationPromptRLE
		call UICall
...
render:
	...
	loadn r0, #100 ; should be the color blue
...
; jump tables: 
	...
	SquareFinderJumpTable:  ; r6 is screen index ; r3 is function id ; uses r2, which is reserved in Square finder, no current conflic but beware
		...
		mov r0, r6 ; r0 is now the screen index
