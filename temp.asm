...
render:
	...
	ScreenRenderHighlightedUI:
		...
		; Check if there's a highlighted element

    		loadn r0, #UICurentlySelectedElement
    		loadi r0, r0  ; Get ID
    		loadn r1, #0
    		cmp r0, r1
    		jeq ScreenRenderIndexExit  ; Skip if no element selected
    		
		; Set screen index changed for highlighted region
    	
			loadn r0, #UICurentlySelectedElement
    		inc r0 ; start pos
    		loadi r2, r0  ; r2 = start pos

			    inc r0
 			   loadi r1, r0  ; r1 = end pos

  			  mov r0, r2  ; r0 = start pos
		...
		ScreenRenderHighlightedUI_loop:
			...
			cmp r0, r2
			jeq ScreenRenderIndexExit_ResetColor
				...
				inc r0
				jmp ScreenRenderHighlightedUI_loop


	ScreenRenderIndexExit_ResetColor:
	...
	UIConfirmationPrompt: var#5 
		...
		UIConfirmationPromptFunction:   ; id 0
			...
			;
				...
				;
				loadn r3, #UICurentlySelectedElement
    			loadn r4, #UIPreviousSelectedElement
